...
# Dossier contenant les fichiers de requêtes (A)
query_folder = "/chemin/vers/dossier/A"

# Dossier contenant les fichiers de données (B)
data_folder = "/chemin/vers/dossier/B"

# Chemin du fichier CSV de sortie
csv_file_path = "resultats.csv"

# Entêtes du fichier CSV
csv_headers = ["Nom du template de requete", "Nom du fichier de requetes", "Nom du fichier de données",
               "Nombre de requêtes", "Nombre de données", "Nombre de requetes sans resultats"]
        ...
        if os.path.isfile(query_file_path):
            ...
            for data_file in os.listdir(data_folder):
                ...
                if os.path.isfile(data_file_path):
                    ...
                    num_queries_without_results = execute_java_program(query_file_path, data_file_path)

                    # Écrire la ligne dans le fichier CSV
                    csv_writer.writerow([query_file, query_file, data_file,
                                        "N/A", "N/A", num_queries_without_results])
